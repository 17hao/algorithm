...
class Code_149_MaxPointsOnLine {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(c.maxPoints(new int[][] { { 1, 2 }, { 2, 3 } }));
        // System.out.println(c.maxPoints(new int[][] { { 1, 1 }, { 3, 2 }, { 5, 3 }, {
        // 4, 1 }, { 2, 3 }, { 1, 4 } }));
        // System.out.println(
        // c.maxPoints(new int[][] { { 1, 1 }, { 3, 2 }, { 5, 3 }, { 4, 1 }, { 2, 3 }, {
        // 1, 4 }, { 4, 1 } }));
        System.out.println(c.maxPoints(new int[][] { { 1, 1 }, { 1, 1 }, { 1, 1, } }));
        System.out.println(c.maxPoints(
